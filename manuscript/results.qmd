...
The improvement for random forest (rf) was relatively low, likely due to the sparse dataset and the method's default setting of fitting only 10 trees. Combined with random variable selection, this made it unlikely for the model to consistently identify the relevant predictors.
