...
To introduce the MARS algorithm, we draw primarily on the explanation provided by @Hastie2017 (pp. 321-326), which offers a more extensive summary of the method and additional theoretical background.
